...
## [0.84.0] — 2026-07-02
Настройки ИИ: поле модели теперь подтягивает список моделей провайдера с поиском (typeahead) и клавиатурной навигацией; свободный ввод сохранён для кастомных моделей (#229)

## [0.83.0] — 2026-07-02
Добавлены AI-провайдеры Google Gemini и OpenRouter (OpenAI-совместимые): выбор в настройках, тест подключения через бесплатный health-check, честное имя провайдера (#228)

## [0.82.0] — 2026-07-02
Groq и другие OpenAI-совместимые провайдеры сообщают своё имя в тесте подключения (было «openai») (#238)
