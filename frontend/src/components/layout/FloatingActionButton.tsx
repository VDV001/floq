              ...
              >
                ...
                >
                  {msg.role === "user" ? (
                    ...
                    <div className="prose prose-sm max-w-none [&_*]:break-words [&_pre]:whitespace-pre-wrap [&_code]:break-all [&_table]:table-fixed [&_td]:break-words prose-headings:text-[#0d1c2e] prose-headings:text-sm prose-headings:font-bold prose-p:my-1 prose-ul:my-1 prose-li:my-0 prose-table:text-xs prose-th:px-2 prose-th:py-1 prose-td:px-2 prose-td:py-1 prose-strong:text-[#0d1c2e]">
